...
def parseCommandLine():
    ...
    parser = argparse.ArgumentParser(description="Add an enclosing bounding box to a set of track files")
...
if __name__ == '__main__':
    ...
    gbb_str = str(gbb.min_longitude)+"/"+str(gbb.min_latitude)+"/"+str(gbb.max_longitude)+"/"+str(gbb.max_latitude)
    if VERBOSE : print("  > Global BBox {}".format(gbb_str))
